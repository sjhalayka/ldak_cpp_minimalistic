...
// The pre-compiled Linux version of LDAK uses Intel MKL libraries; I compile it
...
#define MKL                                                                    \
  0 // 1 to compile with mkl, 0 to compile without mkl, 2 to compile with AOCL
#define MET                                                                    \
  0 // 0 for qsopt, 1 for glpk (for glpk, edit compilation line to include
    // source/glpk.h)
